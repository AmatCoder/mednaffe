...
void scan_files(gchar *romdir, guidata *gui)
{
  ...
  while (hFind != INVALID_HANDLE_VALUE)
  {
    ...
    if (gui->filter == 0)
    {
      ...
      else if ((gui->filter == 3) && (g_str_has_suffix(FindFileData.cFileName, ".cue") ||
                     g_str_has_suffix(FindFileData.cFileName, ".CUE") ||
                     g_str_has_suffix(FindFileData.cFileName, ".gb")  ||
                     g_str_has_suffix(FindFileData.cFileName, ".GB")  ||
                     g_str_has_suffix(FindFileData.cFileName, ".gba") ||
                     g_str_has_suffix(FindFileData.cFileName, ".GBA") ||
                     g_str_has_suffix(FindFileData.cFileName, ".gbc") ||
                     g_str_has_suffix(FindFileData.cFileName, ".GBC") ||
                     g_str_has_suffix(FindFileData.cFileName, ".gg")  ||
                     g_str_has_suffix(FindFileData.cFileName, ".GG")  ||
                     g_str_has_suffix(FindFileData.cFileName, ".lnx") ||
                     g_str_has_suffix(FindFileData.cFileName, ".LNX") ||
                     g_str_has_suffix(FindFileData.cFileName, ".md")  ||
                     g_str_has_suffix(FindFileData.cFileName, ".MD")  ||
                     g_str_has_suffix(FindFileData.cFileName, ".nes") ||
                     g_str_has_suffix(FindFileData.cFileName, ".NES") ||
                     g_str_has_suffix(FindFileData.cFileName, ".ng")  ||
                     g_str_has_suffix(FindFileData.cFileName, ".NG")  ||
                     g_str_has_suffix(FindFileData.cFileName, ".ngc") ||
                     g_str_has_suffix(FindFileData.cFileName, ".NGC") ||
                     g_str_has_suffix(FindFileData.cFileName, ".ngp") ||
                     g_str_has_suffix(FindFileData.cFileName, ".NGP") ||
                     g_str_has_suffix(FindFileData.cFileName, ".pce") ||
                     g_str_has_suffix(FindFileData.cFileName, ".PCE") ||
                     g_str_has_suffix(FindFileData.cFileName, ".sfc") ||
                     g_str_has_suffix(FindFileData.cFileName, ".SFC") ||
                     g_str_has_suffix(FindFileData.cFileName, ".sms") ||
                     g_str_has_suffix(FindFileData.cFileName, ".SMS") ||
                     g_str_has_suffix(FindFileData.cFileName, ".spc") ||
                     g_str_has_suffix(FindFileData.cFileName, ".SPC") ||
                     g_str_has_suffix(FindFileData.cFileName, ".ssf") ||
                     g_str_has_suffix(FindFileData.cFileName, ".SSF") ||
                     g_str_has_suffix(FindFileData.cFileName, ".vb")  ||
                     g_str_has_suffix(FindFileData.cFileName, ".VB")  ||
                     g_str_has_suffix(FindFileData.cFileName, ".ws")  ||
                     g_str_has_suffix(FindFileData.cFileName, ".WS")  ||
                     g_str_has_suffix(FindFileData.cFileName, ".wsc") ||
                     g_str_has_suffix(FindFileData.cFileName, ".WSC") ||
                     g_str_has_suffix(FindFileData.cFileName, ".zip") ||
                     g_str_has_suffix(FindFileData.cFileName, ".ZIP")))
      {
                     ...
                     g_str_has_suffix(file, ".M3U")))
        {
          gui->itemlist = g_slist_prepend(gui->itemlist,
            g_strconcat(file, G_DIR_SEPARATOR_S, testdir, NULL));
                ...
                else if ((gui->filter == 3) && (g_str_has_suffix(file, ".cue") ||
                     g_str_has_suffix(file, ".CUE") ||
                     g_str_has_suffix(file, ".gb") ||
                     g_str_has_suffix(file, ".GB") ||
                     g_str_has_suffix(file, ".gba") ||
                     g_str_has_suffix(file, ".GBA") ||
                     g_str_has_suffix(file, ".gbc") ||
                     g_str_has_suffix(file, ".GBC") ||
                     g_str_has_suffix(file, ".gg") ||
                     g_str_has_suffix(file, ".GG") ||
                     g_str_has_suffix(file, ".lnx") ||
                     g_str_has_suffix(file, ".LNX") ||
                     g_str_has_suffix(file, ".md") ||
                     g_str_has_suffix(file, ".MD") ||
                     g_str_has_suffix(file, ".nes") ||
                     g_str_has_suffix(file, ".NES") ||
                     g_str_has_suffix(file, ".ng") ||
                     g_str_has_suffix(file, ".NG") ||
                     g_str_has_suffix(file, ".ngc") ||
                     g_str_has_suffix(file, ".NGC") ||
                     g_str_has_suffix(file, ".ngp") ||
                     g_str_has_suffix(file, ".NGP") ||
                     g_str_has_suffix(file, ".pce") ||
                     g_str_has_suffix(file, ".PCE") ||
                     g_str_has_suffix(file, ".sfc") ||
                     g_str_has_suffix(file, ".SFC") ||
                     g_str_has_suffix(file, ".sms") ||
                     g_str_has_suffix(file, ".SMS") ||
                     g_str_has_suffix(file, ".spc") ||
                     g_str_has_suffix(file, ".SPC") ||
                     g_str_has_suffix(file, ".ssf") ||
                     g_str_has_suffix(file, ".SSF") ||
                     g_str_has_suffix(file, ".vb") ||
                     g_str_has_suffix(file, ".VB") ||
                     g_str_has_suffix(file, ".ws") ||
                     g_str_has_suffix(file, ".WS") ||
                     g_str_has_suffix(file, ".wsc") ||
                     g_str_has_suffix(file, ".WSC") ||
                     g_str_has_suffix(file, ".zip") ||
                     g_str_has_suffix(file, ".ZIP")))
        {
...
G_MODULE_EXPORT
#endif
void on_radiomenuknown_activate(GtkMenuItem *menuitem, guidata *gui)
{
  if (gui->filter != 3)
  {
    gui->filter=3;
    fill_list(NULL, gui);
    gtk_tree_view_column_set_title(gui->column, " Games with known filetypes");
  }
}
